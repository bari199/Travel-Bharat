...
const TopTrendingSection = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br from-orange-200 via-orange-300 to-orange-300 py-16 px-4 md:px-8">
      ...
      <div className="pointer-events-none absolute -top-10 -left-10 w-64 h-64 overflow-hidden opacity-90">
        <div className="absolute top-2 left-2 w-24 h-24 rounded-full bg-orange-600/70" />
        <svg
          viewBox="0 0 260 200"
          className="absolute inset-0 w-full h-full text-orange-500/30"
          fill="none"
        >
          <path
      ...
      <svg
        ...
        className="pointer-events-none absolute bottom-0 left-0 w-full h-24 text-orange-700/30"
        fill="currentColor"
      >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-orange-600 font-semibold text-xs uppercase tracking-widest">
              Explore India
            </p>
          ...
          <Button
            variant="link"
            className="text-sm font-medium text-gray-700 hover:text-orange-600 hidden sm:flex"
          >
            See All →
          </Button>
        </div>
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll("left")}
            className="hidden md:flex absolute -left-5 top-[38%] -translate-y-1/2 z-20 bg-white shadow-lg rounded-full p-3 hover:scale-105 transition"
          >
          ...
          >
            {trendingDestinations.map((item) => (
              <Card
                key={item.id}
                className="min-w-[280px] max-w-[280px] rounded-2xl border-0 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-white overflow-hidden py-0 gap-0"
              >
                ...
                <CardContent className="p-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 leading-snug line-clamp-2 mt-1">
                    {item.title}
                  </h3>
          ...
          <button
            ...
            className="hidden md:flex absolute -right-5 top-[38%] -translate-y-1/2 z-20 bg-white shadow-lg rounded-full p-3 hover:scale-105 transition"
          >
