...
import { Star, ThumbsUp, ThumbsDown, Send, Trash2 } from "lucide-react";
    ...
    <section className="w-full py-12 bg-white">
      <div className="max-w-5xl mx-auto px-5">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold mt-4">Comments & Reviews</h2>

          <p className="text-gray-500 mt-2">
            Share your experience and read traveler feedback.
          </p>
        </div>
        ...
        <Card className="rounded-3xl mb-8">
          <CardContent className="p-6 space-y-5">
            <div>
              ...
              <div>
                <p className="text-sm mb-3">Rate this destination</p>
            ...
            <Button disabled={loading} onClick={handleAddReview}>
        ...
        <div className="max-h-[700px] overflow-y-auto pr-2 space-y-8">
          ...
          {reviews.map((review) => (
            <div key={review._id} className="border-b pb-8">
              ...
              <p className="mt-4 text-gray-600 leading-7">{review.message}</p>
              ...
              {openReply === review._id && (
                <div className="mt-4 flex gap-3">
                  ...
                  <Button onClick={() => handleReply(review._id)}>Send</Button>
                </div>
              )}
