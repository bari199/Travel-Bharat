...
const RichToolbar = ({ textareaRef, value, onChange }) => {
  ...
  return (
    <div className="flex items-center gap-1 mb-2 p-1.5 bg-gray-50 border border-gray-200 rounded-lg w-fit">
    ...
    <section className="w-full py-14 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-4xl mx-auto px-5">
        ...
        <div className="mb-10">
          <Badge
            variant="outline"
            className="bg-orange-50 text-orange-600 border-orange-200 px-3 py-1 text-xs font-semibold tracking-wide uppercase"
          >
            Traveler Reviews
          </Badge>

          <h2 className="text-3xl font-extrabold tracking-tight mt-3 text-gray-900">
            Comments &amp;{" "}
        ...
        {/* ── COMMENT FORM ── */}
        <Card className="rounded-2xl border border-gray-200 shadow-sm mb-10">
          <CardContent className="p-6 space-y-5">
            <div className="flex items-center gap-2">
              <Award size={18} className="text-orange-500" />
              <h3 className="font-bold text-lg text-gray-800">Leave a Review</h3>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                className="min-h-[130px] resize-none text-sm leading-relaxed border-gray-200 focus:ring-orange-300"
              />
        ...
        >
          ...
          {reviews.map((review, idx) => {
            ...
            return (
              <div
                key={review._id}
                className={`py-7 ${idx !== reviews.length - 1 ? "border-b border-gray-100" : ""}`}
              >
                {/* ── Comment header ── */}
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {isOwner && (
                          <Badge
                            variant="outline"
                            className="text-[10px] px-1.5 py-0 text-orange-500 border-orange-200"
                          >
                            You
                          </Badge>
                        )}
                ...
                {/* ── Comment body ── */}
                <p className="mt-3 text-gray-600 text-sm leading-relaxed pl-[52px]">
                  {review.message}
                </p>
                ...
                <div className="flex items-center gap-2 mt-4 pl-[52px]">
                  <button
                    ...
                    className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full border transition-all font-medium ${
                      rxn.userReaction === "like"
                        ...
                        : "text-gray-500 border-gray-200 hover:border-orange-200 hover:text-orange-500 hover:bg-orange-50"
                    }`}
                  >
                    <ThumbsUp
                      size={13}
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full border transition-all font-medium ${
                      rxn.userReaction === "dislike"
                        ...
                        : "text-gray-500 border-gray-200 hover:border-red-200 hover:text-red-400 hover:bg-red-50"
                    }`}
                  >
                    <ThumbsDown
                      size={13}
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full border border-gray-200 text-gray-500 hover:border-orange-300 hover:text-orange-500 hover:bg-orange-50 transition-all font-medium"
                  >
                ...
                {openReply === review._id && (
                  <div className="mt-4 pl-[52px] flex gap-2">
                    <Input
                      ...
                      className="text-sm border-gray-200 focus:ring-orange-300"
                      onKeyDown={(e) => {
                ...
                {review.replies?.length > 0 && (
                  <div className="pl-[52px] mt-4">
                    <div
                      className="border-l-2 border-orange-100 pl-4 space-y-3 overflow-y-auto"
                      style={{
                        maxHeight: "260px",
                        scrollbarWidth: "thin",
        ...
        <DialogContent className="rounded-2xl sm:max-w-lg">
          ...
          <div className="space-y-3 py-2">
            ...
            <Textarea
              ...
              className="min-h-[140px] resize-none text-sm leading-relaxed border-gray-200 focus:ring-blue-200"
